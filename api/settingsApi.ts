...
export class SettingsApi {
     ...
     * @param settings 
     */
    public async updateSettings (settings: Settings, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Settings;  }> {
        const localVarPath = this.basePath + '/api/v1/settings';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        if (settings === null || settings === undefined) {
            throw new Error('Required parameter settings was null or undefined when calling updateSettings.');
        }
